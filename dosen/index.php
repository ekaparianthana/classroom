...
<body>
	<div id="navigation">
		<div class="container">
			...
			<ul class='main-nav'>
            		<li> <a href='index.php?page=tampil-jadwal.php'> <span> Jadwal Saya </span> </a> </li>
                    <li> <a href='#' class="dropdown-toggle" data-toggle="dropdown"> <span> Jadwal Lainnya </span> <span class='caret'></span></a>
                    	<ul class="dropdown-menu">
                    	 <li> <a href="index.php?page=tampil-jadwal-ruangan.php"> Ruangan </a> </li>
                         <li> <a href="index.php?page=tampil-jadwal-kelas.php"> Kelas </a> </li>
                         <li> <a href="index.php?page=tampil-jadwal-dosen.php"> Dosen </a> </li>
                        </ul>
                    </li>
                    <li> <a href='#' class="dropdown-toggle" data-toggle="dropdown"> <span> Akun </span> <span class='caret'></span> </a> 
                    	 <ul class="dropdown-menu">
                         	<li> <a href="index.php?page=ubah_pass.php&id=<?php echo $_SESSION['id_dosen'];?>">Pengaturan </a> </li>
                            <li> <a href="index.php?page=logout.php">Sign Out </a> </li>
                         </ul>
                    </li>
			</ul>
      		...
      		<div class="user">
            	<div class="dropdown">
					<a href="/classroom_schedules/index.php"> <span> Sign In Admin </span> </a>
				</div>
            </div>
		</div>
	</div> <!-- navigation -->
