<?php
	...
	while(($fileop = fgetcsv($handle,1000,",")) !==false) {
		...
		if($count>1){
			...
			// Get id ruangan 
			$query 	= mysql_query("SELECT id_ruangan FROM ruangan WHERE ruangan = '".$fileop[6]."' ");
...
?>
				<div class="alert alert-info">
                    ...
                    Data Ruangan <?php echo $fileop[6]; ?> tidak ada di Database, Silahkan hubungi Admin Pusat.
				</div>
<?php 
			}
...
?>
					<div class="alert alert-info">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>Pemberitahuan!</strong>  Data Jadwal No. <?php echo $fileop[0] . ". " . $fileop[1]; ?> tidak disimpan.
                        Data Mata Kuliah <?php echo $fileop[2];?> belum tersedia. Silahkan masukkan data di <a href="index.php?page=matkul/input.php">link ini</a>.
					</div>
<?php
				}	
			}
			...
			if (($idRuangan != "Tidak ada")&&($idAktivitas != "Tidak ada")) {
				// Cek Jadwal 
...
<center> <a href="index.php?page=jadwal/tampil-jadwal-kelas.php" class="btn btn-primary">Kembali Ke Jadwal Kelas</a></center>