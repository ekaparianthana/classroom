...
<div class="span12">
	<div class="box">
    	<div class="box-title">
            <div class="pull-left">
                <h2> <i class="icon-reorder"></i> Jadwal Kelas </h2>               
            </div>
        ...
        <div class="box box-color box-bordered">
        	...
        	<div class="box-content nopadding">
            	<div class="tabs-container"> 
                	<ul id="listKelas" class="tabs tabs-inline tabs-left" style="height:792px;overflow:scroll"></ul>
                </div>
...
$(document).ready(function() {
	...
	$('#listKelas').on('click', 'a', function() {
		...
		if (id == "" && idKelas != 'edit-list') { 
			...
			getJadwalKelas(idKelas,id,jurusan,'event');
		} 
	});
	...
	$('#thn_ajar').change(function() {
		...
		if(jurusan == "") {alert('Silahkan pilih Jurusan Terlebih dahulu!'); }
		else {getKelas('list', jurusan);$('#dwnload-excel').show();}
	});
